...
PIPELINE_ANSWER_INSTRUCTION = (
    ...
    "If a retrieved snippet explicitly states the requested recommendation, timing, or action, answer directly from that snippet instead of claiming the context is insufficient. "
    "When the question asks about multiple items, answer each supported item explicitly. "
    "Prefer direct recommendation language over vague summary language or figure captions. "
    ...
    "- If the retrieved context is insufficient, say exactly which requested part is not supported.\n"
    "- If a snippet explicitly says to start, administer, obtain, or measure something, use that action directly in the answer.\n"
    "- If a snippet explicitly contains a timing target such as 1 hour or 3 hours, include that timing in the answer.\n"
